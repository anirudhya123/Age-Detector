...
try:
    ...
    min_range = int(input("Minimum Range of number: -->"))
    max_range = int(input("Maximum Range of number: -->"))
    player_list = []
    score_dict = {}
    ...
    for player in player_list:
        ran_no = random.randrange(min_range, max_range)
        chance = 0
    ...
    print(f"winner is {sorted(score_dict.keys())[0]}")
